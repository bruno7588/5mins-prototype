...
const cards: CardDef[] = [
  {
    ...
    color: '255, 187, 56',
    iconColor: '#FFBB38',
    icon: <Notepad2 size={iconSize} color="var(--secondary-600)" variant="Linear" />,
  ...
  },
  {
    ...
    color: '250, 113, 95',
    iconColor: '#FA715F',
    icon: <VideoSquare size={iconSize} color="var(--lesson-quiz)" variant="Linear" />,
  ...
  },
  {
    ...
    color: '155, 85, 201',
    iconColor: '#9B55C9',
    icon: <VolumeHigh size={iconSize} color="var(--flash-poll)" variant="Linear" />,
  ...
  },
  {
    ...
    color: '0, 206, 230',
    iconColor: '#00CEE6',
    icon: <DocumentText size={iconSize} color="var(--primary-600)" variant="Linear" />,
  ...
  },
  {
    ...
    color: '42, 144, 216',
    iconColor: '#2A90D8',
    icon: <Link2 size={iconSize} color="var(--course-assessments)" variant="Linear" />,
